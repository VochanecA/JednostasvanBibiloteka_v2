...
//click on one and check all checkboxes (vratiKnjigu.ejs)
...
//click on one and check all checkboxes(evidencijaKnjiga.ejs)
$('.checkAll').click(function () {
  if ($(this).is(':checked')) {
    $('.form-checkbox').prop('checked', true);
    $('tr').addClass('bg-gray-200');
    $('tr').children().eq(1).html('<a class="text-blue-800 border-l-2 border-gray-200" href="otpisiKnjigu.ejs"><i class="fa fa-trash ml-4"></i>  Izbrisi knjigu</a>')
...
$('.checkOthers').change(function () {
  ...
  if (checked == 1) {
    ...
    $('tr').children().eq(1).html('<a class="text-blue-800" href="knjigaOsnovniDetalji.ejs"><i class="far fa-copy"></i>  Pogledaj detalje</a>')
    $('tr').children().eq(2).html('<a class="text-blue-800" href="editKnjiga.ejs.ejs"><i class="far fa-copy"></i>  Izmjeni knjigu</a>')
